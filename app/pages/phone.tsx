...
const PhonePage: React.FC = () => {
  ...
  const fetchSessionId = async () => {
    const shopDomain = "whatsapp-with-mern.myshopify.com"; // Set dynamically if needed
    try {
  ...
  const API_BASE_URL =
    "https://unstimulating-semistiff-thuy.ngrok-free.dev/api";
  ...
  const handleOpenModal = (phone?: any) => {
    if (phone) {
      setEditMode(true);
      setForm({
