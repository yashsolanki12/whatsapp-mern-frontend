...
const shopify = shopifyApp({
  ...
  apiSecretKey: "your_shopify_api_secret",
  apiVersion: ApiVersion.October25,
  scopes: "read_products,write_products" == null ? void 0 : "read_products,write_products".split(","),
  appUrl: "your_ngrok_url",
  authPathPrefix: "/auth",
  ...
  sessionStorage: new MongoDBSessionStorage(
    "your_mongodb_url",
    "your_database_name"
    // Add your MongoDB database name here
  )
});
...
const app__index = UNSAFE_withComponentProps(function Index() {
  ...
  useEffect(() => {
    var _a2, _b2;
    if ((_b2 = (_a2 = fetcher.data) == null ? void 0 : _a2.product) == null ? void 0 : _b2.id) {
      shopify2.toast.show("Product created");
    }
  }, [(_b = (_a = fetcher.data) == null ? void 0 : _a.product) == null ? void 0 : _b.id, shopify2]);
        ...
        children: [/* @__PURE__ */ jsx("s-button", {
          ...
          onClick: () => {
            ...
            (_d2 = (_c2 = shopify2.intents).invoke) == null ? void 0 : _d2.call(_c2, "edit:shopify/Product", {
              value: (_b2 = (_a2 = fetcher.data) == null ? void 0 : _a2.product) == null ? void 0 : _b2.id
            });
          },
          target: "_blank",
          variant: "tertiary",
...
const PhonePage = () => {
  ...
  const fetchSessionId = async () => {
    const shopDomain = "whatsapp-with-mern.myshopify.com";
    try {
  ...
  const API_BASE_URL = "https://unstimulating-semistiff-thuy.ngrok-free.dev/api";
